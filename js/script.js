...
function cursorEffect() {
  ...
  document.querySelectorAll("button, .property-card, .page14-inner, .right10-inner").forEach(function (elem) {
...
function loader() {
  ...
  tl.from("#page1 h1, #page1 h4, #page1 button", {
    y: 100,
    opacity: 0,
    duration: 1,
    stagger: 0.3,
...
function canvas() {
 ...
 `;
    return data.split("\n")[index + 1]; // Added +1 because of the leading newline in template literal
  }
